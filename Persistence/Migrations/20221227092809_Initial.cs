    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobDays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobDays_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobDayId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Jobs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Jobs_JobDays_JobDayId",
                        column: x => x.JobDayId,
                        principalTable: "JobDays",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobDays_UserId",
                table: "JobDays",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Jobs_JobDayId",
                table: "Jobs",
                column: "JobDayId");
